...
second_rect_mask = cv2.bitwise_and(second_rect_mask, second_rect_mask, mask=first_rect_mask)
...
third_rect_mask = cv2.bitwise_and(third_rect_mask, third_rect_mask, mask=second_rect_mask)
