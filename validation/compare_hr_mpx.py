...
ds2 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_1.csv', inv=False, subset=None, frac=0, prominence=0.1) # d[:-1], s[1:]
ds3 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_A1_37.csv', inv=False, subset=None, frac=0, prominence=0.2)
ds4 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_A1_60.csv', inv=False, subset=dict(d=1), frac=0, prominence=0.3)
ds5 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_A4_60.csv', inv=False, subset=None, frac=0, prominence=0.1) # s[1:]
ds6 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_C12_1.csv', inv=False, subset=None, frac=0, prominence=0.1, distance=10) # s[1:]
ds7 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_D3_50.csv', inv=False, subset=None, frac=0, prominence=0.1) # s[1:]
ds8 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_H3_90.csv', inv=False, subset=None, frac=0, prominence=0.25) # s[1:]
ds9 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_medium_B2_60.csv', inv=False, subset=None, frac=0, prominence=0.2, distance=10) 
ds10 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_medium_C2_149.csv', inv=False, subset=None, frac=0, prominence=0.1) 
ds11 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_medium_C5_1.csv', inv=False, subset=None, frac=0, prominence=0.2) 
ds12 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_medium_F7_68.csv', inv=False, subset=dict(d=-1), frac=0, prominence=0.3, distance=10) 
ds13 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_medium_G2_113.csv', inv=False, subset=None, frac=0, prominence=0.2) 
ds14 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_medium_G5_1.csv', inv=False, subset=None, frac=0, prominence=0.1) 
ds15 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_medium_G1_82.csv', inv=False, subset=None, frac=0, prominence=0.3, distance=7) 
ds16 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_young_H12_119.csv', inv=False, subset=None, frac=0, prominence=0.4) 
ds17 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_old_B5_26.csv', inv=False, subset=None, frac=0, prominence=0.2) 
ds18 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_old_B8_1.csv', inv=False, subset=None, frac=0, prominence=0.3, distance=5) 
ds19 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_old_D10_42.csv', inv=False, subset=None, frac=0, prominence=0.3) 
ds20 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_old_E5_15.csv', inv=False, subset=None, frac=0, prominence=0.15) 
ds21 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_old_F4_1.csv', inv=False, subset=None, frac=0, prominence=0.1) 
ds22 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_old_F10_21.csv', inv=False, subset=None, frac=0, prominence=0.1) 
ds23 = parse_auto('./data/paleomon/mpx_auto_15_15ppt_old_H6.csv', inv=False, subset=None, frac=0, prominence=0.3, distance=7) 
