...
ds4 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_young_A1_60.csv",
    inv=True,
    subset=None,
    frac=0,
    prominence=0.2,
...
ds7 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_young_D3_50.csv",
    inv=True,
    subset=None,
    frac=0,
    prominence=0.3,
...
ds8 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_young_H3_90.csv",
    inv=False,
    subset=dict(s=1),
    frac=0,
    prominence=0.3,
...
ds9 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_medium_B2_60.csv",
    inv=False,
    subset=dict(d=-1),
    frac=0,
    prominence=0.3,
...
ds10 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_medium_C2_149.csv",
    inv=False,
    subset=None,
    frac=0,
    prominence=0.1,
...
ds11 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_medium_C5_1.csv",
    inv=True,
    subset=dict(d=-1),
    frac=0,
    prominence=0.09,
...
ds12 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_medium_F7_68.csv",
    inv=True,
    subset=dict(s=1),
    frac=0,
    prominence=0.1,
...
ds13 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_medium_G2_113.csv",
    inv=False,
    subset=dict(s=1),
    frac=0,
    prominence=0.1,
...
ds14 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_medium_G5_1.csv",
    inv=False,
    subset=dict(d=-1, s=1),
    frac=0,
    prominence=0.1,
...
ds15 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_medium_G1_82.csv",
    inv=True,
    subset=None,
    frac=0,
    prominence=0.2,
...
ds16 = parse_auto(
    "./data/paleomon/sv_auto_15_15ppt_young_H12_119.csv",
    inv=False,
    subset=None,
    frac=0,
    plot=True,
