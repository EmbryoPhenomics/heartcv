    ...
    return html.Div(children=[
        html.Div(className='row', children=[
            html.Div(className='four columns', children=[
                html.H3(children='HeartCV manual validation tool')
            ]),
        ...
        html.Div(className='row', children=[
            ...
            html.Div(className='four columns', children=[
                ...
                html.Button('Record cardiac cycle', id='cardiac-frame-recorder'),
                ...
                dash_table.DataTable(
                    ...
                    style_cell_conditional=[
                        {'if': {'column_id': col},'width': '25%'} for col in ['ds_frame','ds_area','ss_frame','ss_area']],
