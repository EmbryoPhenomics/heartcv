...
auto = gen_signal('/home/z/Documents/heartcv_testdata/heartcv_testdata_1/15_25ppt_young_1.avi')[:100]
a_events = hcv.find_events(auto, prominence=0.2)
sv_f = [n for i,n in enumerate(a_events[1][0]) if i%2 == 0]
...
auto = gen_signal('/home/z/Documents/heartcv_testdata/heartcv_testdata_1/15_35ppt_old_1.avi')[:100]
...
auto = gen_signal('/home/z/Documents/heartcv_testdata/heartcv_testdata_1/15_40ppt_medium_1.avi')[:100]
a_events = hcv.find_events(auto, prominence=0.2)
sv_f = [n for i,n in enumerate(a_events[1][0]) if i%2 == 0]
